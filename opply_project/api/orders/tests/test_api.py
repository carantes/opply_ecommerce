...
class OrderTests(APITestSetup):
    ...
    def test_get_orders(self):
        ...
        self.assertEqual(results[0].get('customer'), '9feeac87-9058-4c97-a347-ee0b356ee8a1')
    ...
    def test_get_order(self):
        ...
        # Ensure we have the correct data
        self.assertEqual(response.data.get('customer'), '9feeac87-9058-4c97-a347-ee0b356ee8a1')
    ...
    def test_create_order_without_update_inventory(self):
        ...
        """
        url = reverse('order-list')
        data = {'total': 3000, 'order_items': [{'product': 'd8d4d3f5-1a9e-4b0d-9d5e-2d5d3d9e0b1e', 'quantity': 3, 'price': 1000}], 'status': 'completed' }
    ...
    def test_create_order_with_update_inventory(self):
        ...
        """
        url = reverse('order-list')
        data = {'total': 3000, 'order_items': [{'product': '04d5d8be-470b-45e8-b3fe-88b1c412535a', 'quantity': 3, 'price': 1000}] }
